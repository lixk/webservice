# -*- coding: utf-8 -*-
"""
py4js is a fast and simple micro-framework for small web applications. It allows you to use python functions just like
native Javascript functions. It is built on the foundation of bottle: {@link https://www.bottlepy.org}.
